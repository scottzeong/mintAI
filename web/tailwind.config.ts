 ...
 */
// 색상(hue)은 158~165 — 청록보다 초록 쪽에 가까운 민트.
//
// 2026-07-25에 한 번 178~186(청록)으로 옮겼다가 되돌렸다. 청록은 더 차갑지만
// 이름이 mintAI 다 — 민트는 초록에서 출발하는 색이고, 청록으로 가면 이름과
// 화면이 어긋난다. 더 차갑게 가고 싶다면 색상보다 채도를 낮추는 쪽이 낫다.
const mint = {
  50: '#f1faf6',
  100: '#dcf3e8',
  200: '#b8e5d1',
